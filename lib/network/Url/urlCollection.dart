class UrlCollection{
  ...
  static String baseUrl = 'https://mdqualityapps.in/API/gross_shop/development/';
  static String Login = baseUrl+'deliveryperson/signin';
  static String updateProfile = baseUrl+'deliveryperson/update';
  ...
  static String forgetPassword = baseUrl+'deliveryperson/forgot-password';
